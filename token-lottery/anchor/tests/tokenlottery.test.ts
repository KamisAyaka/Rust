...
import { Tokenlottery } from '../target/types/tokenlottery.js'
...
describe('token-lottery', () => {
  ...
  before('Loading switchboard program', async () => {
    // 使用正确的Switchboard On-Demand程序ID
    const switchboardProgramId = new anchor.web3.PublicKey('SBondMDrcV3K4kxZR1HNVT7osZxAHVHgYXL5Ze1oMUv')
    const switchboardIDL = await anchor.Program.fetchIdl(switchboardProgramId, {
