import { getTokenlotteryProgramId, getGreetInstruction } from '@project/anchor'
...
export function useGetProgramAccountQuery() {
  ...
  return useQuery({
    ...
    queryFn: () => client.rpc.getAccountInfo(getTokenlotteryProgramId(cluster.id)).send(),
  })
}

export function useGreetMutation() {
  const programAddress = useTokenlotteryProgramId()
